"""
pipeline/steps/_geoaware/utils_py3d.py   (env: geo-aware)

Standalone look-at camera helpers copied from PyTorch3D
(pytorch3d/common/datatypes.py + pytorch3d/renderer/cameras.py) so the
geo-aware env does not need a pytorch3d install.
"""
...
def look_at_view_transform(
    ...
    Args:
        ...
        up: the up direction of the world coordinate system.
